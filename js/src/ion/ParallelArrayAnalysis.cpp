...
class ParallelArrayVisitor : public MInstructionVisitor
{
  ...
  public:
    ...
    UNSAFE_OP(AsmUDiv)
    UNSAFE_OP(AsmUMod)
    UNSAFE_OP(AsmLoadHeap)
    UNSAFE_OP(AsmStoreHeap)
    UNSAFE_OP(AsmLoadGlobalVar)
    UNSAFE_OP(AsmStoreGlobalVar)
    UNSAFE_OP(AsmLoadFuncPtr)
    UNSAFE_OP(AsmLoadFFIFunc)
    UNSAFE_OP(AsmReturn)
    UNSAFE_OP(AsmVoidReturn)
