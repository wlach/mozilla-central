...
class HTMLElement(object):
    ...
    def tap(self, x=None, y=None):
        '''
        Simulates a tap (touchstart, touchend) on the element.
...
class Actions(object):
    ...
    All action methods (press, etc.) return the object itself, to make
    ...
    def perform(self):
        '''
        Sends the action chain built so far to the server side for execution.
        '''
